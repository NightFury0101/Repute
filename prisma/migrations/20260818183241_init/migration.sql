...
-- AddForeignKey
ALTER TABLE "ProductBundle" ADD CONSTRAINT "ProductBundle_bundledProductId_fkey" FOREIGN KEY ("bundledProductId") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;
